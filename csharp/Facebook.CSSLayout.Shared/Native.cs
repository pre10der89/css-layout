...
namespace Facebook.CSSLayout
{
    internal static class Native
    {
...
#elif WINDOWS_UWP
        private const string DllName = "CSSLayout.Universal.Dll";
#else
        private const string DllName = "CSSLayout.Desktop.Dll";
#endif
        ...
        [DllImport(DllName, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        public static extern void CSSNodeFreeRecursive(IntPtr cssNode);
        ...
        [DllImport(DllName, ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool CSSNodeCanUseCachedMeasurement(CSSMeasureMode widthMode,
                                                                 float width,
                                                                 CSSMeasureMode heightMode,
                                                                 float height,
                                                                 CSSMeasureMode lastWidthMode,
                                                                 float lastWidth,
                                                                 CSSMeasureMode lastHeightMode,
                                                                 float lastHeight,
        ...
        #region CSS_LAYOUT_EXPERIMENTAL
